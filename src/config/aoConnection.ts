...
export const AO_CONFIG = {
  MU_URL: import.meta.env.VITE_MU_URL || DEFAULT_CONFIG.MU_URL,
  CU_URL: import.meta.env.VITE_CU_URL || DEFAULT_CONFIG.CU_URL,
  GATEWAY_URL: import.meta.env.VITE_GATEWAY_URL || DEFAULT_CONFIG.GATEWAY_URL,
};
